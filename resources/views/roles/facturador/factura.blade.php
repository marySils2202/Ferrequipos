...
<body>
  ...
  @include('roles.facturador.factura.partials.buscar_factura_modal')
  @include('roles.facturador.factura.partials.nuevo_cliente_modal')
  @include('roles.facturador.factura.partials.registrar_compra_modal')
</body>
</html>
